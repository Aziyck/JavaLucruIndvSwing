...
public class RuteDAOimpl implements RuteDAO {
    ...
    private static final String SQL_INSERT = "INSERT INTO public.\"rute\"(\"persid\", \"dataplecarii\", \"oraplecarii\", \"locatieinitiala\", \"datasosirii\", \"orasosirii\", \"destinatie\", \"durata\", \"nrsaptamanii\", \"locuridisponibileconfort\", \"locuriconfort\", \"pretconfort\", \"locuridisponibileeco\", \"locurieco\", \"preteco\", \"idziua\") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
    private static final String SQL_SELECT_ALL = "SELECT \"persid\", \"codcursa\", \"dataplecarii\", \"oraplecarii\", \"locatieinitiala\", \"datasosirii\", \"orasosirii\", \"destinatie\", \"durata\", \"nrsaptamanii\", \"locuridisponibileconfort\", \"locuriconfort\", \"pretconfort\", \"locuridisponibileeco\", \"locurieco\", \"preteco\", \"idziua\" FROM public.\"rute\";";
    private static final String SQL_SELECT_BY_ID = "SELECT \"persid\", \"codcursa\", \"dataplecarii\", \"oraplecarii\", \"locatieinitiala\", \"datasosirii\", \"orasosirii\", \"destinatie\", \"durata\", \"nrsaptamanii\", \"locuridisponibileconfort\", \"locuriconfort\", \"pretconfort\", \"locuridisponibileeco\", \"locurieco\", \"preteco\", \"idziua\" FROM public.\"rute\" WHERE \"persid\" = ?;";
    private static final String SQL_DELETE_BY_ID = "DELETE FROM public.\"rute\" WHERE \"persid\"=?;";
    private static final String SQL_DELETE_BY_OBJECT = "DELETE FROM public.\"rute\" WHERE \"persid\" = ? and \"dataplecarii\" = ? and \"oraplecarii\" = ? and \"locatieinitiala\" = ? and \"datasosirii\" = ? and \"orasosirii\" = ? and \"destinatie\" = ? and \"durata\" = ? and \"nrsaptamanii\" = ? and \"locuridisponibileconfort\" = ? and \"locuriconfort\" = ? and \"pretconfort\" = ? and \"locuridisponibileeco\" = ? and \"locurieco\" = ? and \"preteco\" = ? and \"idziua\" = ? ;";
    private static final String SQL_UPDATE = "UPDATE public.\"rute\" SET \"dataplecarii\"=?, \"oraplecarii\"=?, \"locatieinitiala\"=?, \"datasosirii\"=?, \"orasosirii\"=?, \"destinatie\"=?, \"durata\"=?, \"nrsaptamanii\"=?, \"locuridisponibileconfort\"=?, \"locuriconfort\"=?, \"pretconfort\"=?, \"locuridisponibileeco\"=?, \"locurieco\"=?, \"preteco\"=?, \"idziua\"=? WHERE \"persid\" = ?;";
